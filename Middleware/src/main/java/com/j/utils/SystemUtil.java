...
public class SystemUtil {
	...
	public static String getIMEI(Context context) {
		...
		if (null == telMgr) {
			Log.d("com.kinghanhong.middleware",
					"SystemUtil.java, getIMEI(),get telephone service fail!");
			return null;
		}
	...
	public static String getApkVersion(Context context) {
		...
		try {
			...
			Log.d("com.kinghanhong.middleware",
					"SystemUtil.java,getApkVersion(context),exception occur:"
	...
	public static String getApkVersion(Context context, String archiveFilePath) {
		...
		try {
			PackageInfo info = pkgManager.getPackageArchiveInfo(
			...
			Log.d("com.kinghanhong.middleware",
					"SystemUtil.java,getApkVersion(context,archiveFilePath),exception occur:"
							+ e.getLocalizedMessage());
			e.printStackTrace();
			return null;
		}
	...
	public static void screenShot(View v, String filePath) {
		...
		if (bitmap != null) {
			...
			try {
				...
				FLog.i(TAG, "get bitmap done :" + filePath);
			} catch (Exception e) {
				e.printStackTrace();
			}
		} else {
